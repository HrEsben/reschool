...
export const SMILEY_OPTIONS: SmileyOption[] = [
  ...
  { unicode: '😝', name: 'Squinting Face with Tongue', category: 'silly', description: 'Drillende med tunge' },
  { unicode: '😜', name: 'Winking Face with Tongue', category: 'silly', description: 'Blinker med tunge' },
  { unicode: '😇', name: 'Smiling Face with Halo', category: 'silly', description: 'Uskyldig engel' },
  { unicode: '🙃', name: 'Upside-Down Face', category: 'silly', description: 'På hovedet' },
  ...
  { unicode: '😟', name: 'Worried Face', category: 'worried', description: 'Bekymret' },
  { unicode: '🤔', name: 'Thinking Face', category: 'neutral', description: 'Tænker' },
  ...
  { unicode: '🥳', name: 'Partying Face', category: 'excited', description: 'Fejrer og festligt' },
  { unicode: '😈', name: 'Smiling Face with Horns', category: 'silly', description: 'Djævelsk grin' },
  { unicode: '🤬', name: 'Face with Symbols on Mouth', category: 'angry', description: 'Bander og sværger' },
  { unicode: '😤', name: 'Face with Steam from Nose', category: 'angry', description: 'Frustreret og irriteret' },
  ...
  { unicode: '😑', name: 'Expressionless Face', category: 'neutral', description: 'Udtryksløst ansigt' },
  { unicode: '😐', name: 'Neutral Face', category: 'neutral', description: 'Neutralt udtryk' },
